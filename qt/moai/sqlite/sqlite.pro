...
QMAKE_CFLAGS    += -w -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DSQLITE_ENABLE_COLUMN_METADATA
QMAKE_CFLAGS    += -D_UNICODE -DUNICODE -D_LIB -DNDEBUG -Dfdatasync=fsync
...
SOURCES 	+= ../../../3rdparty/sqlite-3.6.16/sqlite3.c
