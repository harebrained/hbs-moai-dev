...
QMAKE_CXXFLAGS    += -DAKU_STATIC -D_USE_32BIT_TIME_T -DUSE_CURL -DCURL_STATICLIB -DCURL_DISABLE_LDAP
QMAKE_CFLAGS    += -DAKU_STATIC -D_USE_32BIT_TIME_T -DUSE_CURL -DCURL_STATICLIB -DCURL_DISABLE_LDAP
