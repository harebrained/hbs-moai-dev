...
win32{
    INCLUDEPATH += ../../../3rdparty/jansson-2.1/src-win32
    HEADERS += ../../../3rdparty/jansson-2.1/src-win32/jansson_config.h
}
...
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/dump.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/error.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/hashtable.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/load.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/memory.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/pack_unpack.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/strbuffer.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/utf.c
SOURCES 	+= ../../../3rdparty/jansson-2.1/src/value.c
